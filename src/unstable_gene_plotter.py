...
def plotter(dict, gradient, intercept, pear_r, p_val, x_label, y_label, xaxis_label, yaxis_label, title, file_name, colour):
    ...
    x_data = np.array(dict[x_label], dtype=np.float64)
    plt.plot(x_data, gradient*x_data + intercept, colour,
...
def main():
    ...
    for label, coord in gene_dict.items():
        ...
        gene_data["lambda_2"].append(coord[6])
    ...
    plotter(gene_data, m_1, c_1, r_1, p_1, "t_1/2",
            "T1_exp", 'mRNA Half-Life' + r' $t_{1/2}$' + ' (s)', 'Mean Translation Time' +
            r' $\langle T \rangle$' + ' (s)', 'Mean Translation Time' + r' $\langle T \rangle$' +
            ' vs. mRNA Half-Life' + r' $t_{1/2}$',
            "unstable_T1_half.png", 'r')

    # Initiation Time vs. Half-life.
    m_2, c_2 = get_fit(gene_data, "t_1/2", "lambda_2")
    r_2, p_2 = get_correlation(gene_data, "t_1/2", "lambda_2")
    plotter(gene_data, m_2, c_2, r_2, p_2, "t_1/2",
            "lambda_2", 'mRNA Half-Life (s)', 'Initiation Time ' +
            r'[$\lambda$] ' + '(s)', 'Initiation Time vs. mRNA Half-Life',
            "unstable_lambda_2_half.png", 'b')
    ...
    plotter(gene_data, m_4, c_4, r_4, p_4, "t_1/2",
            ...
            "unstable_alpha_half.png", 'tab:orange')
    ...
    plotter(gene_data, m_5, c_5, r_5, p_5, "CDS",
            "T1_exp", 'CDS Length (codons)', 'Mean Translation Time' +
            r' $\langle T \rangle$'+ ' (s)', 'Mean Translation Time ' + r' $\langle T \rangle$' + ' vs. CDS',
            "unstable_t1_cds.png", 'tab:orange')

    # Translation Time vs. Initiation Time.
    m_6, c_6 = get_fit(gene_data, "lambda_2", "T1_exp")
    r_6, p_6 = get_correlation(gene_data, "lambda_2", "T1_exp")
    plotter(gene_data, m_6, c_6, r_6, p_6, "lambda_2",
            "T1_exp", 'Initiation Time ' +
            r'[$\lambda$] (s)', 'Mean Translation Time' +
            r' $\langle T \rangle$' + ' (s)', 'Mean Translation Time' + r' $\langle T \rangle$' +' vs. Initiation Time' + r' $\lambda$',
            "unstable_t1_lambda_2.png", 'b')
    ...
    plotter(gene_data, m_7, c_7, r_7, p_7, "alpha",
            ...
            r'[$\alpha$] ($s^{-1}$)', 'Mean Translation Time' +
            r' $\langle T \rangle$' + ' (s)', 'Mean Translation Time ' + r'$ \langle T \rangle $ ' + 'vs. Initiation Rate ' + r'$\alpha$',
            "unstable_t1_alpha.png", 'g')
    ...
    plotter(gene_data, m_8, c_8, r_8, p_8, "CDS",
            ...
            "unstable_alpha_cds.png", 'tab:orange')
